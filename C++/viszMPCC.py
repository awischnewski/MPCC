...
# plot predictions
ax1.plot(logs[5][idx][0], logs[5][idx][1], 'r--')
ax2[0].plot(range(idx, idx+60), logs[5][idx][2])
ax2[1].plot(range(idx, idx+60), logs[5][idx][4])
ax2[2].plot(range(idx, idx+60), logs[5][idx][3])
